...
В отдельных фрагментах открываются данные по фильму, актеру или другому кинематографисту, а также 
сводки по отдельным сезонам сериалов.
...
Для более подробного знакомства с приложением можно обатиться к тех.хаданию и figma-макету по адресу https://www.figma.com/design/IIkauEDQXNEAbzLtBufGOj/skillcinema-(Copy)?m=auto&t=F5O6r2FkJLGH71jL-1
